...
object LayoutDubul {
    @JvmField
    val JAMO_DUBUL_STANDARD = arrayOf(
    ...
    @JvmField
    val COMB_DUBUL_STANDARD = arrayOf(
    ...
    @JvmField
    val JAMO_DUBUL_DANMOEUM_GOOGLE = arrayOf(
    ...
    @JvmField
    val COMB_DUBUL_DANMOEUM_GOOGLE = arrayOf(
